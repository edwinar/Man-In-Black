...
public class UserMypageDto implements Serializable {
    ...
    public int getPRO_SEQl() {
        return PRO_SEQl;
    }

    public void setPRO_SEQl(int PRO_SEQl) {
        this.PRO_SEQl = PRO_SEQl;
    }
