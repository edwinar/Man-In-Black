...
public class UserMypageDto implements Serializable{
	...
	public String toString() {
		return "UserMypageDto [ADDRESS=" + ADDRESS + ", COLOR=" + COLOR + ", COUP_LIMIT=" + COUP_LIMIT + ", COUP_NAME="
				+ COUP_NAME + ", COUP_PRICE=" + COUP_PRICE + ", COUP_USE=" + COUP_USE + ", DEL_SEQ=" + DEL_SEQ
				+ ", DEL_STEP=" + DEL_STEP + ", EMAIL=" + EMAIL + ", INCREASE=" + INCREASE + ", POINT_FINAL="
				+ POINT_FINAL + ", POINT_PRICE=" + POINT_PRICE + ", POINT_SEQ=" + POINT_SEQ + ", POINT_TIME="
