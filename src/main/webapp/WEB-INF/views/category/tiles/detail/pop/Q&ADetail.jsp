...
<div class="layout">
	<div class="thumbnail">
		...
		<div style="height: 10%; width: 100%;">
			<p align="left" style="margin-left: 30px;">
				제목 : <input type="text" value="그래서 사이즈 뭐입어?" readonly="readonly">
			</p>
		</div>
		<div style="height: 35%; width: 100%;">
			<p><h5 align="left" style="margin-left: 30px;">내용</h5></p>
			<textarea rows="5px" cols="100px" readonly="readonly">니들이 게맛을 알아?</textarea>
		</div>
		<div class="btn" align="center" style="height: 10%; width:100%;">
			<div style="float: left; width: 50%;">
				<button style="width: 50%; height: 100%;">수정하기</button>
			</div>
			<div style="float: right; width: 50%;">
				<button style="width: 50%; height: 100%;">삭제하기</button>
			</div>
		</div>
	</div>
</div>
